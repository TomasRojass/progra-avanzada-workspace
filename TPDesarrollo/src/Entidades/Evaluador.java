...
public class Evaluador {
	...
	public void iniciar() {
		...
		//int gananciaMaxima = ganancia(this.presupuesto.getValor(), this.fabricantes, this.compradores, numeroDeFabricanteSeleccionado, numeroDeCompradorSeleccionado);

		int gananciaMaxima = ganancia(this.presupuesto.getValor(), this.fabricantes, this.compradores, numeroDeFabricanteSeleccionado,
		...
		if (gananciaMaxima == Constante.RESIGNAR_NEGOCIO) {
			...
			System.out.println("Comprando a al fabricante " + numeroDeFabricanteSeleccionado.getValor() + " y vendiendole al comprador "
	...
	public int ganancia(int presupuesto, List<Fabricante> fabricantes, List<Comprador> compradores, MutableInt numeroDeFabricanteSeleccionado, MutableInt numeroDeCompradorSeleccionado) {
		...
		//System.out.println("======================== Compradores Ordenado ========================");
		//mostrarCompradores(compradores);
	...
	/*public int gananciaViejo(int presupuesto, List<Fabricante> fabricantes, List<Comprador> compradores,
	...
	private void mostrarFabricantes(List<Fabricante> fabricantes) {
		...
		for (Fabricante fabricante : fabricantes) {
			System.out.println("Fabricante: " + numeroDeFabricante++ + "\t" + fabricante + "\tCosto total: " + fabricante.getCantidadMinimaDeUnidades() * fabricante.getPrecioACobrarPorUnidad());
		}
	}
	...
	private void mostrarCompradores(List<Comprador> compradores) {
		for (Comprador comprador : compradores) {
			System.out.println("Comprador: " + comprador.getNumero() + "\t" + comprador + "\tCosto total: " + comprador.getCantidadDeUnidadesAComprar() * comprador.getPrecioAPagarPorUnidad());
		}
	}
}
