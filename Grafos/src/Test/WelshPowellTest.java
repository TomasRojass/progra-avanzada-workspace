...
public class WelshPowellTest {
	...
	public void testEjercicioDeClase() {
		...
		Coloreo<Character> coloreoGrafo = welshPowell.colorearGrafo(grafoDeCaracteres);
	...
	public void testEjercicioRecuperatorio() {
		...
		Coloreo<Integer> coloreoGrafo = welshPowell.colorearGrafo(grafoDeEnteros);
		int resultadoObtenido = coloreoGrafo.getNumeroCromatico();
		int resultadoEsperado = 3;
