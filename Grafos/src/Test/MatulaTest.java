...
import Coloreo.Matula;
import Entidades.Grafo;
import Entidades.GrafoLista;
import Entidades.Vertice;

public class MatulaTest {

	private Matula matula;
	...
	public void testEjercicioDeClase() {
		...
		Coloreo<Character> coloreoGrafo = matula.colorearGrafo(grafoDeCaracteres);
		System.out.println(coloreoGrafo);
		int resultadoObtenido = coloreoGrafo.getNumeroCromatico();
		int resultadoEsperado = 4;

		// En el ejemplo del apunte, devuelve 3, pero depende de como se ordenen los vertices
	...
	public void testEjercicioRecuperatorio() {
		...
		Coloreo<Integer> coloreoGrafo = matula.colorearGrafo(grafoDeEnteros);
		int resultadoObtenido = coloreoGrafo.getNumeroCromatico();
