...
public class DFSTest {
	...
	public void testEjercicioDeClase() throws VerticeInvalidoException {
		...
		boolean[] resultadoEsperado = { true, true, true, true, true, true, true, true, true, true, true, false,
				false };
		boolean[] resultadoObtenido = dfs.recorrerGrafo(grafoDeEnteros, cero);
	...
	public void testVerticeNoPerteneceAlGrafo() throws VerticeInvalidoException {
		...
		DFS<Integer> dfs = new DFS<>();
		dfs.recorrerGrafo(grafoDeEnteros, verticeNoEnGrafo);
	}
